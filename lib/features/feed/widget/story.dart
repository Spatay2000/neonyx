...
//   void initState() {
//     super.initState();
//     stories = (widget.feedEntity
//             .where((feed) => feed.storyImage != null)
//             .expand((feed) => feed.storyImage ?? [])
//             .whereType<Story>()) // Фильтруем только элементы типа Story
//         .toList();
//     // stories.add(Story(
...
//       setState(() {
//         currentPageValue = controllerPage.page;
//       });
//     });
//   }
